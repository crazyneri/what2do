...
<div class="venue_form-container">
    @if ($venue->id === null)
        <form class="create-venue" action="/admin/venue/create" method="post">
    @else
        <form class="create-venue" action="/admin/venue/{{$venue->id}}" method="post">
        @method('put')
    @endif
